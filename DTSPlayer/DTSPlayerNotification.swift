...
public extension Notification.Name {
    ...
    static let DTSPlayerUserTappedNextButton = Notification.Name(rawValue: "com.dtsplayer.DTSPlayerUserTappedNextButton")
    static let DTSPlayerCurrentItemDidChange = Notification.Name(rawValue: "com.dtsplayer.DTSPlayerCurrentItemDidChange")
}
