...
struct MenuItems: Codable {
    ...
    static var filmsVC: MenuItems {
        return MenuItems(id: "ItemNavVC", name: TabBarItemTag.movies.description, icon: "Movies", tag: .movies)
    }
    static var seriesVC: MenuItems {
        return MenuItems(id: "ItemNavVC", name: TabBarItemTag.shows.description, icon: "Series", tag: .shows)
    }
    static var cartoonsVC: MenuItems {
        return MenuItems(id: "ItemNavVC", name: TabBarItemTag.cartoons.description, icon: "Cartoons", tag: .cartoons)
    }
    static var docMoviesVC: MenuItems {
        return MenuItems(id: "ItemNavVC", name: TabBarItemTag.documovie.description, icon: "Documentary Movie", tag: .documovie)
    }
    static var docSeriesVC: MenuItems {
        return MenuItems(id: "ItemNavVC", name: TabBarItemTag.docuserial.description, icon: "Documentary Series", tag: .docuserial)
    }
    static var tvShowsVC: MenuItems {
        return MenuItems(id: "ItemNavVC", name: TabBarItemTag.tvshow.description, icon: "Television", tag: .tvshow)
    }
    static var concertsVC: MenuItems {
        return MenuItems(id: "ItemNavVC", name: TabBarItemTag.concert.description, icon: "Concert", tag: .concert)
    }
    static var collectionsVC: MenuItems {
        return MenuItems(id: "CollectionsNavVC", name: TabBarItemTag.collections.description, icon: "Collection", tag: .collections)
    }
    static var movies4kVC: MenuItems {
        return MenuItems(id: "ItemNavVC", name: TabBarItemTag.movies4k.description, icon: "4K", tag: .movies4k)
    }
    static var movies3dVC: MenuItems {
        return MenuItems(id: "ItemNavVC", name: TabBarItemTag.movies3d.description, icon: "3D", tag: .movies3d)
    }
