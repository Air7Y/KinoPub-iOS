...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LKAlertController-tvOS/LKAlertController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MarqueeLabel-tvOS/MarqueeLabel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Mixpanel-tvOS/Mixpanel.framework"
